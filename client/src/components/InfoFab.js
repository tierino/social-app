      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            (json-server) containing posts and a separate authentication server
            that stores users in a MongoDB database. The application contains
            post, delete, like and reply functionalities. Hosted by Heroku.
